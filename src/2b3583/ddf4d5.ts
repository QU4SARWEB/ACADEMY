  ...
  return `
    ...
    <div class="glass rounded-xl p-6 space-y-6">
      ...
      <div class="rounded-xl border border-[#8B5CF6]/20 bg-[#8B5CF6]/5 p-4">
        ...
        <div class="relative mx-auto aspect-square w-56 overflow-hidden rounded-lg border border-zinc-700 bg-zinc-900" id="coach-img-preview">
          ${profile.presentation_image
            ? `<img id="coach-img" src="${profile.presentation_image}" alt="" class="h-full w-full object-cover" />`
        ...
        <p class="mt-1 text-xs text-zinc-500">Esta imagen se muestra en la tarjeta del roster público. Recomendado: cuadrado 1:1 (800x800 o similar).</p>
      </div>` : ''}
