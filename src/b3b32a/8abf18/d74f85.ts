  ...
  try {
          ...
          <div class="grid gap-4 sm:grid-cols-2">
            <div>
              ...
              <select name="course_type" id="field-type"
                ...
                <option value="intensive">Coaching Intensivo — $40/15 días</option>
              </select>
            </div>
            <div>
            ...
            <div>
              ...
              <div class="flex items-center gap-3">
                <input type="number" name="price" id="field-price" value="15" min="0" step="0.01"
    ...
    document.getElementById('course-form')!.addEventListener('submit', async (e) => {
      ...
      const { data: course, error } = await supabase.from('courses').insert({
        ...
        price: fd.get('isFree') === 'on' ? 0 : (parseFloat(fd.get('price') as string) || 15),
