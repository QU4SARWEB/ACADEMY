  ...
  ;(async () => {
    try {
      ...
      const html = `
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="flex gap-2">
              ...
              <a href="#/coaches/courses/${escapeHtml(id)}/exams"
                class="rounded-lg border border-zinc-700 px-3 py-2 text-sm text-zinc-300 transition hover:bg-zinc-800">Exámenes</a>
              <a href="#/coaches/courses/${escapeHtml(id)}/attendance"
        ...
        ${(course as any).description ? `<div class="glass mb-6 rounded-xl p-4 text-sm text-zinc-300">${escapeHtml((course as any).description)}</div>` : ''}
